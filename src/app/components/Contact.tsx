    ...
    return (
        ...
        >
            ...
            <SmartLink
                ...
                className="inline-flex items-center gap-2 bg-primary text-secondary-text font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-btn-bg-secondary transition"
            >
                <FaLinkedin size={20} />
                LinkedIn
            </SmartLink>
